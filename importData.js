...
const CryptoSymbols = require("./api/models/cryptoSymbolsModel");
const StockSymbols = require("./api/models/stockSymbolsModel");
...
const importData = async () => {
  try {
    // Read files
    const coinInfo = readData(path.join(__dirname, "coin-info.json"));
